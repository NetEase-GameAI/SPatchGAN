...
### Pretrained Models
- Download the pretrained models in [google drive](https://drive.google.com/drive/folders/1uU0pUp8dnLikW4twuuFUelPSgLQGt2fF?usp=sharing), and put them in the output directory.
- We provide both the checkpoints (./checkpoint) and the frozen models (./checkpoint/pb). The same results can be generated by both ways.
...
- We also provide the generated results of the last 100 test images (./gen) for the calibration purpose.
